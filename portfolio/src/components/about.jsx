  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 dark:from-custom-dark dark:to-custom-dark-secondary animate-gradient-xy flex items-center justify-center pt-16 sm:pt-20 lg:pt-24 py-8 sm:py-12 transition-colors duration-300">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Title with Responsive Size, No Gradient, and Waving Emoji */}
        <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold text-center text-gray-900 dark:text-white mb-2 sm:mb-3 font-poppins">
          Hey!{' '}
          <span className="inline-block animate-smooth-wave" role="img" aria-label="Waving Hand">
            👋
          </span>{' '}
          Explore My Portfolio!
        </h1>
        {/* Subtitle with Gradient Color Effect */}
        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 animate-gradient-text font-montserrat mb-6 sm:mb-8">
          I'm a Web Developer & AI Enthusiast
        </h2>

        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          {/* Left Side: Profile Picture and Social Icons */}
          <div className="lg:w-1/3 flex flex-col items-center lg:items-start">
            ...
            />
            {/* Centered Social Media Icons with Slight Right Shift on Laptops */}
            <div className="flex justify-center gap-3 sm:gap-4 lg:translate-x-4">
              <a
